...
contract ConvertorFactory {
    event NewConvertor(address indexed convertor, address indexed asset, address indexed want);
    ...
    function isDeployedConvertor(address _strategy) external view returns (bool) {
