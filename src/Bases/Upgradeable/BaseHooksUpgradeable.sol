...
import {BaseHealthCheckUpgradeable, ERC20} from "./BaseHealthCheckUpgradeable.sol";

/**
 *   @title Base Hooks - Upgradeable Version
 ...
 *
 *   This is an upgradeable version that works with proxy patterns.
 */
abstract contract BaseHooksUpgradeable is BaseHealthCheckUpgradeable, Hooks {
    /*//////////////////////////////////////////////////////////////
                            INITIALIZATION
    //////////////////////////////////////////////////////////////*/
     ...
     * it from being initialized outside of a proxy context.
     */
    constructor() {
    ...
    /**
     * @notice Used to initialize the BaseHooks internally.
     *
     * @dev This should be called atomically with initialization of the
     * derived strategy contract through a public initializer function.
     *
     * Example usage in derived strategy:
     * ```solidity
     * function initialize(
     *     address _asset,
     *     string memory _name,
     ...
     *     // Initialize strategy-specific state variables here
     * }
     * ```
     *
    ...
    function redeem(uint256 shares, address receiver, address owner, uint256 maxLoss) public returns (uint256 assets) {
        _preWithdrawHook(assets, shares, receiver, owner, maxLoss);
        assets = abi.decode(
            _delegateCall(
                // Have to use encodeWithSignature due to overloading parameters.
